  ...
  <div class="col-md-12">    
           ...
           <!-- Wrapper for slides -->
              <div class="carousel-inner">
                 <div class="item active">
							...
							<div class="item">
								<img src="<?php echo base_url('assets/front/images/slider/1.jpg') ?>" alt="2">
							</div>
							<div class="item">
	...
	<div class="row" id="city">
		<div class="section">
			<div class="col-md-12 text-center">
				<h5 class="font-purple font-bold font-xl">MARI BERBAGI KEBAHAGIAAN</h5>
				<p class="font-medium font-md">donasi anda akan sangat bermanfaat untuk mereka</p>
				<br><br>
	...
	<div class="row bg-img" id="rentyour">
		<div class="section font-white">
			<div class="col-md-12 text-center">
				<h2 class="font-lg font-bold ">SEDEKAH SORE</h2><br>
				<div class="col-md-6">
				<p class="font-md font-medium">Mari Berbagi Kebahagiaan<br>Dari SEDEKAH kita bisa belajar membahagiakan orang lain sekaligus
					membersihkan hatidan harta dari nafsu setan</p>
				</div>
				<div class="col-md-6">
				<p class="font-md font-medium">Menjadi platform donasi yang transparansi dan akuntabilitas serta berperan meningkatkan
					kualitas hidup masyarakat adalah VISI kami</p>
				</div>
				<br>
			</div>
		</div>
