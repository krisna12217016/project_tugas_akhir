...
<head>
	...
	<title>Feedback - Sedekah Sore</title>
...
<div class="container-fluid">
   ...
   <div class="section">
        <div class="mt-inner">
        <h1 class="font-bold font-l text-left" style="margin-top: 150px">Beri Kami Masukan Anda</h1>
          <br>
         ...
         <div class="col-md-6">
             <h1 class="text-content font-bold font-xl">Sedekah Sore</h1>
             <br>
             <h2 class="text-content font-bold font-xl">Mari Berbagi Kebahagiaan</h2>
             <br>
            <p class="text-content font-lg" >"Dari SEDEKAH kita belajar membahagiakan orang lain sekaligus membersihkan hati dan harta dari nafsu setan"</p>
         </div>
      </div>
    </div>
</div>
